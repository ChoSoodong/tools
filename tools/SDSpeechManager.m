...
#import "SDSpeechManager.h"
#import <AVFoundation/AVFoundation.h>

@interface SDSpeechManager () <AVSpeechSynthesizerDelegate>
{
...
@implementation SDSpeechManager

+ (instancetype)sharedInstance
{
    static SDSpeechManager *single = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        single = [[SDSpeechManager alloc] init];
    });
    return single;
}
