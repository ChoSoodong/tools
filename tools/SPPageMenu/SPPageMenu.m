...
-(void)setDividingLineOffsetX:(CGFloat)dividingLineOffsetX{
    _dividingLineOffsetX = dividingLineOffsetX;
    [self setNeedsLayout];
    [self layoutIfNeeded];
}
...
- (void)layoutSubviews {
    ...
    CGFloat dividingLineW = _dividingLineOffsetX == 0? self.bounds.size.width :(self.bounds.size.width - _dividingLineOffsetX*2);
    CGFloat dividingLineH = (self.dividingLine.hidden || self.dividingLine.alpha < 0.01) ? 0 : _dividingLineHeight;
    CGFloat dividingLineX = _dividingLineOffsetX == 0? 0 : _dividingLineOffsetX;
